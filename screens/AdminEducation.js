...
const Educator = () => {
  ...
  const handleEducation = () => {
    ...
    axios
      .post("http://192.168.1.105:80/pangasolo/AdminEducation.php", formData, {
  ...
  return (
    <View style={styles.profile}>
      <KeyboardAvoidingView behavior="position" style={styles.container}>
        ...
        <Text style={[styles.profile1, styles.profile1Clr]}>Education</Text>
        ...
        <View style={[styles.lastName, styles.usernameLayout]}>
          <View style={[styles.username1, styles.usernameLayout]}>
            <View style={[styles.usernameChild, styles.childBorder]} />
            <Text style={[styles.username2, styles.profile1Clr]}>SubTitle:</Text>
            <TextInput
              style={[styles.name, styles.nameTypo]}
              value={subTitle}
