...
const OtpVerification1 = () => {
  ...
  return (
    <View style={styles.otpVerification1}>
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/otp-11.png")}
      />
      ...
      <View style={styles.otpNumber}>
        ...
        <View style={[styles.otpNumberInner, styles.lineViewBorder]} />
        <View style={[styles.lineView, styles.lineViewBorder]} />
        <Text style={[styles.text1, styles.textTypo]}>7</Text>
        <Text style={[styles.text2, styles.textTypo]}>3</Text>
      </View>
      <Pressable
        style={[styles.verifyButton, styles.verifyButtonLayout]}
      ...
      >
        ...
        />
        <Image
          style={[styles.maskGroupIcon, styles.verifyButtonLayout]}
          resizeMode="cover"
          source={require("../assets/mask-group11.png")}
        />
        <Text style={styles.verify}>Verify</Text>
        <View style={[styles.verifyButtonItem, styles.verifyLayout]} />
      </Pressable>
    </View>
  );
};
